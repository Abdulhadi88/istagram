...
class AcountSettingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        change_setimage_text.setOnClickListener {
            ...
            CropImage.activity()
                .setAspectRatio(1,1)
                .start(this@AcountSettingActivity)
    ...
    private fun userInfo() {
        val userReference = FirebaseDatabase.getInstance().getReference()
    ...
    private fun updateUserInfoOnly() {
        when{
            ...
            else ->
            {
                ...
                userReference.child(firebaseUser.uid).updateChildren(userMap)

                Toast.makeText(this,"Profile berhasil di update", Toast.LENGTH_SHORT).show()
                val intent = Intent(this@AcountSettingActivity, MainActivity::class.java)
                startActivity(intent)
                finish()
            }
