...
import com.example.istagram.CommentActivity
import com.example.istagram.MainActivity
...
class PostAdapter(private val mContext: Context, private val mPost: List<Post>): RecyclerView.Adapter<PostAdapter.ViewHolder>() {
    ...
    class ViewHolder(@NonNull itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        var saveButton: ImageView = itemView.findViewById(R.id.post_save_button)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.commentButton.setOnClickListener {
            val intenComment = Intent(mContext, CommentActivity::class.java)
